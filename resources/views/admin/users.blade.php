    ...
    <div class="my-3 p-3 bg-white rounded shadow-sm">
        ...
        <table class="table table-striped table-hover">
            ...
            <tr>
                ...
                <td>Admin</td>
                <td>
                    <a href="#" class="delete" title="Бан" data-toggle="tooltip"><i class='fas fa-ban' style='font-size:18px;color:red'></i></a>
                    <a href="#" class="delete" title="Разбанить" data-toggle="tooltip"><i class='fas fa-check' style='font-size:18px;color:green'></i></a>
                </td>
            </tr>
            </tbody>
        </table>
